  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <View style={styles.inputContainer}>
        ...
        />
        <Text style={[styles.inputLabel, isNameFocused && { top: -10, fontSize: 12, color: "#4f23ff" }]}>Name</Text>
        <View style={[styles.inputHighlight, isNameFocused && { width: "100%" }]} />
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity style={styles.button} title="Signup" onPress={handleSignup}>
